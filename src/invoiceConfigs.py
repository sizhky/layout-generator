...
def config1():
    ...
    page = construct_page(
        ...
        H(1, id="BuyerContact"),
        H(10, id="Table"),
        H(3, [V(7), V(3, [H(1, id="Subtotal"), H(1, id="Tax"), H(1, id="Total")])]),
        H(4, id="Footer"),
    )
    return page
...
def config2():
    ...
    page = construct_page(
        H(
            4,
            [
                V(7, [H(2, id="Logo"), H(2, id="Header")]),
                V(3, [H(2, id="SellerName"), H(1.5, id="SellerAddress")]),
            ],
        ),
        H(
            4,
            [
                V(2, [H(1, id="BuyerName"), H(1, id="BuyerAddress")]),
                V(2, [H(1, id="ShipName"), H(1, id="ShipAddress")]),
                V(2, [H(1, id="InvoiceNumber"), H(1, id="Date")]),
            ],
        ),
        H(4, id="Table"),
        H(
        ...
        H(2, [V(7, id="Comments"), V(3, id="Total")]),
        H(1, id="Footer"),
    )
    return page
    ...
    page = construct_page(
        ...
        H(
            ...
            [
                ...
                V(2.5, [H(1, id="Date"), H(1, id="PaymentType"), H(1, id="VehicleNo")]),
            ],
        ),
        H(4, id="Table"),
        H(1, [V(8), V(2, id="Total")]),
        H(2, [V(4), V(2, id="CentralTax"), V(2, id="StateTax"), V(2, id="Tax")]),
        H(1, id="Footer"),
    )
...
def config4():
    ...
    page = construct_page(
        H(2, [V(6, id="Header"), V(4, id="Logo")]),
        H(
            3,
            [
                V(4, [H(1, id="SellerName"), H(2, id="SellerAddress")]),
                V(4, [H(1, id="BuyerName"), H(2, id="BuyerAddress")]),
                V(2, [H(1, id="InvoiceNumber"), H(1, id="Date"), H(1, id="DueDate")]),
            ],
        ),
        H(3, id="Table"),
        H(
...
def config5():
    ...
    page = construct_page(
        H(
            ...
            [
                V(2, id="Logo"),
                V(8, [H(1.5, id="SellerName"), H(1.5, id="SellerAddress")]),
            ],
        ),
        H(1, [V(5, id="GSTIN"), V(5, id="Location")]),
        H(0.5, id="Header"),
        H(1, [V(5, id="InvoiceNumber"), V(5, id="Date")]),
        H(
            3,
            [
                V(
                    5,
                    [H(1, id="BuyerID"), H(1, id="BuyerName"), H(1, id="BuyerAddress")],
                ),
                V(5, [H(1, id="PaymentType"), H(1), H(1, id="DueDate")]),
            ],
        ),
        H(4, id="Table"),
        H(1, [V(5), V(2, id="Tax"), V(2, "Total")]),
        H(3, [V(5, id="Comments"), V(5, [H(1, id="Tax"), H(1, id="Total")])]),
        H(1, [V(5, id="SellerSign"), V(5, id="BuyerSign")]),
        H(1, id="Footer"),
    )
    ...
    page = construct_page(
        H(
            ...
            [
                ...
                V(4, [H(1, id="Date"), H(1, id="DueDate"), H(1, id="BuyerID")]),
            ],
        ),
        H(
            3,
    ...
    page = construct_page(
        H(
            ...
            [
                V(
                    ...
                    [
                        H(2, id="SellerName"),
                        H(2, [V(5, id="SellerAddress"), V(5, id="SellerContact")]),
                    ],
                ),
                V(2, id="Logo"),
            ],
        ...
        H(
            ...
            [
                ...
                V(3, [H(1, id="Date"), H(1, id="InvoiceDate"), H(1, id="DueDate")]),
            ],
        ),
        H(3, id="Table"),
        H(1, [V(4), V(2, id="TaxRate"), V(2, id="Tax"), V(2, id="Total")]),
        H(3, [V(6, [H(2, id="BankDetails"), H(1, id="Terms")]), V(4, id="SellerSign")]),
    )
...
def config8():
    ...
    page = construct_page(
        H(1.5, [V(20, id="Logo"), V(60, id="Header"), V(25, id="InvoiceInfo")]),
        H(2, [V(3, id="SellerInfo"), V(3, id="BuyerInfo"), V(4, id="DeliveryInfo")]),
        H(3, id="Table"),
        H(2, [V(7, id="Sign"), V(3, id="AmountBreakup")]),
        H(1, id="Footer"),
    )
    return page
...
def config9():
    url = (
        "https://www.freshbooks.com/wp-content/uploads/invoice-template-word-blue.jpeg"
    )
    page = construct_page(
        H(1, id="Header"),
        H(1, [V(2, id="SellerAddress"), V(2, id="SellerContact"), V(6)]),
        H(1.2, id="BuyerInfo"),
        H(3, [V(2, id="InvoiceInfo"), V(8, id="Table")]),
        H(2.5, [V(7.5), V(2.5, id="AmountBreakup")]),
        H(0.5, id="Footer"),
    )
    return page
...
def config11():
    ...
    page = construct_page(
        H(2, [V(6, id="Logo"), V(4, id="SellerInfo")]),
        H(1.5, [V(2, id="BuyerInfo"), V(5), V(2, id="InvoiceInfo")]),
        H(3, id="Table"),
        H(2, [V(6, id="Notes"), V(4, id="Total")]),
        H(2, id="Footer"),
    )
    return page
...
def config12():
    ...
    page = construct_page(
        ...
        H(1, id="InvoiceInfo"),
        H(3, id="Table"),
        H(1.5, [V(8, id="WordAmount"), V(2, id="Total")]),
    )
    return page
...
def config13():
    ...
    page = construct_page(
        H(1, [V(5, id="Logo"), V(5, id="Header")]),
        H(1.5, [V(5, id="SellerInfo"), V(5, id="InvoiceInfo")]),
        H(2, [V(5, id="BuyerInfo"), V(5, id="ShipInfo")]),
        H(4, id="Table"),
        H(2, [V(5, id="Comments"), V(5, id="AmountBreakup")]),
    )
    return page
...
def config24():
    ...
    page = construct_page(
        H(1, [V(1, id="SellerName"), V(1, id="Header")]),
        H(
            2,
            [
                V(1, id="SellerInfo"),
...
def config29():
    ...
    page = construct_page(
        ...
        H(1.5, [V(1, id="Graph"), V(1, id="Table")]),
        H(1, [V(1, id="Notes"), V(1, id="Total")]),
        H(1, [V(1, id="PaymentType"), V(1, id="SellerContact")]),
    )
    return page
...
def config30():
    ...
    page = construct_page(
        ...
        H(3, id="BuyerInfo"),
        H(1.5, [V(1, id="Comments"), V(1, id="DueDate")]),
        H(1.5, id="Table"),
        H(2.5, id="Footer"),
    )
    return page
...
def config31():
    ...
    page = construct_page(
        ...
        H(1.5, [V(1, id="BuyerContact"), V(1, id="Total")]),
        H(0.5, id="Footer"),
    )
    return page
